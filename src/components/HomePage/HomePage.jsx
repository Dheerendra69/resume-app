    ...
    <div className="homepage_container">
      <div className="homepage_left">
        ...
        <p className="homepage_left_description">
          ...
          responsive, user-friendly websites and applications. Alongside my web
          development skills, I am proficient in Data Structures and Algorithms
          (DSA), which enhances my problem-solving abilities. I enjoy tackling
          complex coding challenges and continuously improving my code
          efficiency. My hands-on experience with projects has honed my
          analytical thinking and debugging skills. I am eager to contribute to
          a dynamic team, learn from experienced developers, and grow in the
